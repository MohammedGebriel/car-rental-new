          ...
          <div className=" sm:hidden">
            ...
            >
              ...
              <SwiperSlide>
                ...
                <span className=" absolute top-0 left-0 bg-[#00000083] group-hover/part:z-[8] h-full w-full"></span>
                <div className=" absolute top-0 left-0 text-white group-hover/part:z-[8] h-full w-full flex flex-col gap-2 justify-center items-center">
                    <span className=" border border-white rounded-full p-[10px]"><LiaArrowRightSolid    className="text-[20px]"/></span>
                    <span className="">More Photos</span>
